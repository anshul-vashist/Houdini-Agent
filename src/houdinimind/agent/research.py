...
class ResearchManager:
    ...
    def run_single_experiment(
        self, node_path: str, parms: dict[str, Any], metric_type: str = "cook_time"
    ) -> dict:
        """
        1. Backup parms
        2. Set new parms
        ...
        if not HOU_AVAILABLE:
            return {"status": "error", "message": "No Houdini"}
        ...
        try:
            ...
            return {"status": "ok", "value": val, "backups": backups}
