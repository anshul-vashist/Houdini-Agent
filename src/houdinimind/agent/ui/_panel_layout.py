    ...
    def _build_ui(self):
        ...
        for attr, label, tip in [
            ...
            (
                "learn_btn",
                "Learn",
                "Run learning cycle \u2014 mines conversation history for new recipes and updates the knowledge base.",
            ),
        ...
        """)
        self.turn_strip.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        ...
        self.turn_meta_lbl.setStyleSheet(f"color: {ModernStyles.TEXT_SUBTLE}; font-size: 10px;")
        ...
        self.scene_summary_box.setPlaceholderText("The final build summary will appear here.")
        ...
        self.scene_diff_box.setPlaceholderText("Scene changes and output paths will appear here.")
        ...
        self.dry_run_btn.setToolTip("Plan and simulate changes without modifying the scene")
        ...
        self.composer_autoresearch_action = self.composer_actions_menu.addAction("Train")
        ...
        self.turn_counter_lbl.setStyleSheet(f"color: {ModernStyles.TEXT_SUBTLE}; font-size: 10px;")
