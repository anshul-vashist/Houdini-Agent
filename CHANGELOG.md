...
- Local-first execution using Ollama for privacy and performance.
- Hierarchical planning and verification pipeline (Plan → Act → Observe → Verify).
- Vision-guided self-correction and multi-view semantic scoring.
